...
class FrankaExample(VecTask):
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        max_agg_bodies = num_franka_bodies    # 1 for table, table stand, cubeA, cubeB
    ...
    def init_data(self):
        ...
        # dofname=self.gym.get_sim_dof_names(env_ptr, franka_handle)
        print(self.gym.get_actor_joint_dict(env_ptr, franka_handle))
        print(self.gym.get_actor_dof_names(env_ptr, franka_handle))
        # exit()
        # Initialize states
        self.states.update({
    ...
    #     # self._i    # self._reset_init_cube_state(cube='A', env_ids=env_ids, check_valid=True) = True
    ...
    #     num_resets = len(env_ids)
        ...
        # # Example: Check if env_ids are within valid range
        # if torch.max(env_ids) >= self._global_indices.size(0):
        #     raise ValueError("env_ids contain indices out of bounds")
